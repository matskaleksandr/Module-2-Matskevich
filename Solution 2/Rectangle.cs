...
namespace Solution_2
{
    class Rectangle : Shape
    {
        ...
        //метод для вычисления площади и периметра прямоугольника
        public void AreaAndPerimeter()
        {
            ...
            //вычисление площади и периметра прямоугольника и установка их в базовом классе Shape
            base.Area_ = dWidth * dLength;
            base.Perimeter_ = 2 * (dWidth + dLength);
        }
    }
}
